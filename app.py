...
def get_image():
    ...
    if img:
        ...
        if result == 0:
            st.markdown('<p style="color:lime; font-size: 30px;font-weight:bold">Real Currency detected</p>', unsafe_allow_html=True)
        elif result == 1:
...
####    
st.sidebar.text("Created By : Bhavya pratyusha")
